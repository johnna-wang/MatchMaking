...
<!-- menu -->
	...
	<nav class="nav-container hidden hideNav w3_nav">
	  <ul class="nav-list">
		...
		<li class="list-item active"><a href="services.jsp"><i class="glyphicon glyphicon-cog" aria-hidden="true"></i></a></li>
	...
	<div class="services">
		...
		<div class="wthree_services_grid">
			<div class="col-xs-4 wthree_services_left">
				...
				<!-- 用户登录过 -->
				<c:if test="${USER!=null }">
					<a href="MatchServlet?name=${USER.name }"><span class="glyphicon glyphicon-heart" aria-hidden="true"></span>
				</a>
				</c:if>
				...
				<c:if test="${USER.name ==null }">
					<a href="match.jsp"><span class="glyphicon glyphicon-heart" aria-hidden="true"></span>
				</a>
				</c:if>
...
<!-- services-bottom -->
	<div class="services-bottom">
		<h3>我们的关系管理员已经帮助成千上万的会员找到了他们完美的生活伴侣。</h3>
		<div class="more m1">
			<a href="#small-dialog" class="sim-button button9 play-icon popup-with-zoom-anim"><span>登录</span></a>
		</div>
	</div>
<!-- //services-bottom -->
<!-- footer -->
