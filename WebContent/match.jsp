...
<!-- your-search -->
		...
		<div class="agileinfo_your_search_right">		
			<h3 style="text-align:center">你的匹配结果</h3>		
		
			
			<c:forEach  items="${peoples }" var="people" varStatus="s">
				<div class="agileinfo_your_search_right_grid">
				
				<h4>${people.name }</h4>
				<div class="agileinfo_search_grid_left">
				<a href="GallertServlet?name=${people.name }">
					<img src="images/${people.name }.png" alt="照片 " class="img-responsive" />
				</a>
				...
				<div class="agileinfo_search_grid_right">
					...
					<ul>
						<li><span style="color:red">匹配度 : ${people.degree }%</span></li>
						<li><span>年龄</span> : ${people.age }</li>
						<li><span>宗教</span> : ${people.religion }</li>
						
						<li><span>位置</span> : ${people.location }</li>
						<li><span>职业</span> : ${people.profession}</li>
						<li><span>状态</span> : ${people.status }</li>
