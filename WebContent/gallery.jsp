...
<html lang="en">
<head>
<title>Matchmaking a Mobile App Flat Bootstrap Responsive Website Template | Gallery :: 小贝壳网站模板</title> 
...
<!-- 未登录时 -->
		...
		<!-- 未登录时 -->
			<c:if test="${USER==null }">
			<h1 style="text-align:center">登录后才能使用此功能，3s后跳到主页面，若未跳转请点击
			<a href="main.jsp">这里</a>
			</h1>
	...
	<nav class="nav-container hidden hideNav w3_nav">
	  <ul class="nav-list">
		...
		<li class="list-item"><a href="about.jsp"><i class="glyphicon glyphicon-info-sign" aria-hidden="true"></i></a></li>
...
<!-- gallery -->
	<div class="gallery">
		<h3>${people.name }的照片画廊</h3>
		<div class="gallery_grids">
			<div class="agile_gallery_grid">
				<div class="agile_gallery_grid_w3">
					<img src='images/${people.name }.png' data-big-src='images/13.jpg' alt=" " />
					<p  style='opacity:0;display:none'>Quis autem vel eum iure reprehenderit qui in ea voluptate.</p>
				</div>
				<div class="agile_gallery_grid_left_grid">
					<div class="agile_gallery_grid_left agile_gallery_grid_w3">
			...
			<div class="agile_gallery_grid">
				<div class="agile_gallery_grid_left_grid agile_gallery_middle">
					<div class="agile_gallery_grid_left agile_gallery_grid_w3">
						<img src='images/12.jpg' data-big-src='images/12.jpg' alt=" " />
						<p  style='opacity:0;display:none'>Quis autem vel eum iure reprehenderit qui in ea voluptate.</p>
					</div>
